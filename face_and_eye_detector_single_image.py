...
import cv2 as cv        # open cv provides a real time optimisation computer vission library tool and hard ware
import numpy as np      # used for dlib # dlib detects the facial landmark from pretraind models
